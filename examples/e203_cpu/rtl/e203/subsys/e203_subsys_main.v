...
`endif//}
  ...
  // adder
  //wire                         adder_icb_cmd_valid;
  //wire                         adder_icb_cmd_ready;
  //wire                         adder_icb_cmd_read;
  //wire    [31:0]               adder_icb_cmd_addr;
  //wire    [31:0]               adder_icb_cmd_wdata;
  //wire    [3:0]                adder_icb_cmd_wmask;

  //wire                         adder_icb_rsp_valid;
  //wire                         adder_icb_rsp_ready;
  //wire    [31:0]               adder_icb_rsp_rdata;
  //wire                         adder_icb_rsp_err;
  ...
  //  .rst_n              (per_rst_n          ),
    ...
    // icb slave
  //  .icb_cmd_valid      (adder_icb_cmd_valid),
  //  .icb_cmd_ready      (adder_icb_cmd_ready),
  //  .icb_cmd_read       (adder_icb_cmd_read ),
  //  .icb_cmd_addr       (adder_icb_cmd_addr ),
  //  .icb_cmd_wdata      (adder_icb_cmd_wdata),
  // .icb_cmd_wmask      (adder_icb_cmd_wmask),
    
  //  .icb_rsp_valid      (adder_icb_rsp_valid),
  //  .icb_rsp_ready      (adder_icb_rsp_ready),
  //  .icb_rsp_rdata      (adder_icb_rsp_rdata),
  //  .icb_rsp_err        (adder_icb_rsp_err  )
  //);
...
e203_subsys_clint u_e203_subsys_clint(
  ...
  e203_subsys_perips u_e203_subsys_perips (
    ...
    .mhsa_icb_cmd_valid    (mhsa_icb_cmd_valid),
    .mhsa_icb_cmd_ready    (mhsa_icb_cmd_ready),
    .mhsa_icb_cmd_read     (mhsa_icb_cmd_read ),
    .mhsa_icb_cmd_addr     (mhsa_icb_cmd_addr ),
    .mhsa_icb_cmd_wdata    (mhsa_icb_cmd_wdata),
    .mhsa_icb_cmd_wmask    (mhsa_icb_cmd_wmask),
    
    .mhsa_icb_rsp_valid    (mhsa_icb_rsp_valid),
    .mhsa_icb_rsp_ready    (mhsa_icb_rsp_ready),
    .mhsa_icb_rsp_rdata    (mhsa_icb_rsp_rdata),
    .mhsa_icb_rsp_err      (mhsa_icb_rsp_err  ),
